...
public  static WebDriver driver;
	...
	public static Util.WebEventListener eventListener;
	...
	try {
		...
		prop = new Properties();
		FileInputStream ip = new FileInputStream("C:\\Eclips instalation setup\\CucumberPageObjectModel\\src\\main\\java\\Config\\Config.properties");
		prop.load(ip);
